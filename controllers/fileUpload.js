...
exports.imageUpload = async (req, res) => {
    try{
        ...
        const response = await uploadFileToCloudinary(file, "ShivaData");
...
exports.imageSizeReducer = async (req,res) => {
    try{
        ...
        //file format supported hai
        console.log("Uploading to ShivaData");
        //TODO: height attribute-> COMPRESS
        const response = await uploadFileToCloudinary(file, "ShivaData", 90);
        console.log(response);
